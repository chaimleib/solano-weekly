...
THIS_DIR = File.dirname $0
APPLICATION_NAME = 'Google Apps Script Execution API Ruby Quickstart'
CLIENT_SECRETS_PATH = File.join THIS_DIR, '../client_secret.json'
...
# files or initiating an OAuth2 authorization request via InstalledAppFlow.
...
SCRIPT_ID = 'M__VBAQYbTN_h2aT6AzOaaMI8Cv8aA4MM'  #'ENTER_YOUR_SCRIPT_ID_HERE'
